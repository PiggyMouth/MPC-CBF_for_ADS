...
class FollowLeadingVehicle(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._first_vehicle_location = 100  # 25
        self._first_vehicle_speed = 14  # 10
    ...
    def set_speed(self, speed):
        self._first_vehicle_speed = speed
...
class FollowLeadingVehicleWithObstacle(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True):
        ...
        """
        self._map = CarlaDataProvider.get_map()
        self._first_actor_location = 100
        self._second_actor_location = self._first_actor_location + 100  # + 41
        self._first_actor_speed = 14
