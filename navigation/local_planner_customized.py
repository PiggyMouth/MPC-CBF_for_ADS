...
import carla
from navigation.controller_customized import VehiclePIDController
...
class LocalPlanner(object):
    ...
    def run_step(self, waypoint, debug=False):
        ...
        target_waypoint = carla.Transform(location=carla.Location(
            waypoint[0], waypoint[1], 0.0), rotation=carla.Rotation(0.0, 0.0, 0.0))
        # move using PID controllers
        control, _ie = self._vehicle_controller.run_step(
