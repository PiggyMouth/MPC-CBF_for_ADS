...
class VehiclePIDController():
    ...
    def run_step(self, target_speed, waypoint):
        ...
        at a given target_speed.
            ...
            :param waypoint: target location encoded as a waypoint transform
        ...
        if current_steering > self.past_steering + 0.01:
...
class PIDLongitudinalController():
    ...
    def _pid_control(self, target_speed, current_speed):
        ...
        return np.clip((self._k_p * error) + (self._k_d * _de) + (self._k_i * _ie), -1.0, 1.0), _ie
